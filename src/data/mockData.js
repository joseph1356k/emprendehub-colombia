...
export const MOCK_OPPORTUNITIES = [
  ...
  },
  {
    ...
    organization: 'MinTIC',
    description: 'Acompanamiento para startups tecnologicas en etapa de producto temprano.',
    type: 'Aceleracion',
    status: 'Abierta',
    stages: ['Idea', 'Validacion'],
  ...
  },
  {
    ...
    description: 'Credito para empresas en crecimiento con tasas preferenciales.',
    type: 'Credito',
    status: 'Abierta',
...
export const MOCK_COURSES = [
  {
    ...
    lessons: 8,
    level: 'Basico',
    instructor: 'Ana Martinez · Co-fundadora Startups Bogota',
    tags: ['MVP', 'Investigacion', 'Lean Startup'],
    stages: ['Idea', 'Validacion']
  },
  {
    id: 'course-2',
...
export const MOCK_PROVIDERS = [
  {
    ...
    category: 'Branding',
    description: 'Especialistas en creacion de marca para startups digitales.',
    city: 'Medellin',
    rating: 4.8,
  ...
  },
  {
    ...
    category: 'Marketing',
    description: 'Growth marketing y performance para startups que quieren crecer.',
    city: 'Bogota',
    rating: 4.8,
